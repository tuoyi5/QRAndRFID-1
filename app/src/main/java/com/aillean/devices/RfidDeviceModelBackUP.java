...
public class RfidDeviceModelBackUP {

    private static final String TAG = RfidDeviceModelBackUP.class.getSimpleName();
    ...
    public RfidDeviceModelBackUP(Context context, EventBus eventBus) {
